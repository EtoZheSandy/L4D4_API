...
const pool = require('../../utils/mysqlModer'); // Подключаем пул соединений
const router = express.Router();
const routeCache = require("route-cache");

router.get('/v1/cuptimig', routeCache.cacheSeconds(30), async (req, res) => {
    ...
    try {
        ...
        const [cup_Timig] = await connection.query('SELECT * FROM cup_Timig;');
